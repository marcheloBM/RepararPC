...
public class FrCliente extends javax.swing.JFrame {
    ...
    public void defineTablaClientes(String strBusqueda,long DesdeHoja){
        ...
        String strTitulos[]={"ID","RUT","NOMBRE","APELLIDO","CORREO","CELULAR"};
...
//        DAOCliente classCliente= new DAOCliente();
    ...
    private void txtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyPressed
        ...
        btnBuscar.setEnabled(txtBuscar.getText().length() != 0);
...
//            Logger.getLogger(FrCliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txtRutKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRutKeyReleased
        // TODO add your handling code here:
        btnAgregar.setEnabled(txtRut.getText().length() != 0);
