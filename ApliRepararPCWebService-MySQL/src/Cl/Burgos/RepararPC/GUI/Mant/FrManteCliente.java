...
//        classCliente.leerClientes(lngDesdeRegistro, (Long.valueOf(this.txtNumReg.getText())),tablaClientes,strBusqueda);
        List<cl.burgos.repararpc.service.ClCliente> lista=listaClienteAll(lngDesdeRegistro, (Long.valueOf(this.txtNumReg.getText())),strBusqueda);
    ...
    private void JTabClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTabClientesMouseClicked
        ...
        if (fila > -1){
            try {
                ...
                datosCliente=leerClienteId( Integer.parseInt(txtIdCliente.getText()));
                
                this.txtIdCliente.setText(datosCliente.get(0));
                ...
                this.txtIdLogin.setText(datosCliente.get(6));
...
//            this.cmbConsorcio.grabFocus();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            // TODO add your handling code here:
            boolean resp = buscarRutClienteT(txtRut.getText());
            boolean resp2 = insertarCliente(txtRut.getText(), txtNombre.getText(),
                txtApellido.getText(), txtCorreo.getText(), txtCelular.getText(),
                Integer.parseInt(txtIdLogin.getText()));
            if(!resp){
                if(!resp2){
...
//            Logger.getLogger(FrManteCliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        // TODO add your handling code here:
        try {
            boolean resp = actualizarCliente(Integer.parseInt(txtIdCliente.getText()),
                txtRut.getText(), txtNombre.getText(),
                txtApellido.getText(), txtCorreo.getText(), txtCelular.getText(),
                Integer.parseInt(txtIdLogin.getText()));
//             TODO add your handling code here:
...
//            Logger.getLogger(FrManteCliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            boolean resp = eliminarCliente(Integer.parseInt(txtIdCliente.getText()));
            // TODO add your handling code here:
            if(!resp){
...
//            Logger.getLogger(FrManteCliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private static java.util.List<cl.burgos.repararpc.service.ClCliente> listaClienteAll(long intDesde, long intCuantos, java.lang.String strBusqueda) {
        cl.burgos.repararpc.service.WebClienteService_Service service = new cl.burgos.repararpc.service.WebClienteService_Service();
        cl.burgos.repararpc.service.WebClienteService port = service.getWebClienteServicePort();
        return port.listaClienteAll(intDesde, intCuantos, strBusqueda);
    }

    private static java.util.List<java.lang.String> leerClienteId(int id) throws Exception_Exception {
        cl.burgos.repararpc.service.WebClienteService_Service service = new cl.burgos.repararpc.service.WebClienteService_Service();
        cl.burgos.repararpc.service.WebClienteService port = service.getWebClienteServicePort();
        return port.leerClienteId(id);
    }

    private static boolean buscarRutClienteT(java.lang.String rut) throws Exception_Exception {
        cl.burgos.repararpc.service.WebClienteService_Service service = new cl.burgos.repararpc.service.WebClienteService_Service();
        cl.burgos.repararpc.service.WebClienteService port = service.getWebClienteServicePort();
        return port.buscarRutClienteT(rut);
    }

    private static boolean insertarCliente(java.lang.String rut, java.lang.String nombre, java.lang.String apellido, java.lang.String correo, java.lang.String celular, int idLogin) throws Exception_Exception {
        cl.burgos.repararpc.service.WebClienteService_Service service = new cl.burgos.repararpc.service.WebClienteService_Service();
        cl.burgos.repararpc.service.WebClienteService port = service.getWebClienteServicePort();
        return port.insertarCliente(rut, nombre, apellido, correo, celular, idLogin);
    }

    private static boolean actualizarCliente(int id, java.lang.String rut, java.lang.String nombre, java.lang.String apellido, java.lang.String correo, java.lang.String celular, int idLogin) throws Exception_Exception {
        cl.burgos.repararpc.service.WebClienteService_Service service = new cl.burgos.repararpc.service.WebClienteService_Service();
        cl.burgos.repararpc.service.WebClienteService port = service.getWebClienteServicePort();
        return port.actualizarCliente(id, rut, nombre, apellido, correo, celular, idLogin);
    }

    private static boolean eliminarCliente(int id) throws Exception_Exception {
        cl.burgos.repararpc.service.WebClienteService_Service service = new cl.burgos.repararpc.service.WebClienteService_Service();
        cl.burgos.repararpc.service.WebClienteService port = service.getWebClienteServicePort();
