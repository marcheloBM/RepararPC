<%-- 
    Document   : ListarPCCliente
    Created on : 17-12-2018, 4:30:44
    Author     : march
--%>
...
<!DOCTYPE html>
<%String idPcCliente = (String) ("" + session.getAttribute("id_cliente"));%>
<html>
    <head>
    ...
    <body>
        ...
        <tr align="center">
                 ...
                 <%
                     ...
                     List<ClComputador> list = dAOComputador.leerPCIdCliente(0, reg, "",Integer.parseInt(idPcCliente));
