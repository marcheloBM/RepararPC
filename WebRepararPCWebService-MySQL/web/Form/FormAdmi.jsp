...
<!DOCTYPE html>    
	...
	java.lang.String nombre = request.getParameter("txtNombre");
        java.lang.String apellido = request.getParameter("txtApellido");
        java.lang.String correo = request.getParameter("txtCorreo");
        java.lang.String celular = request.getParameter("txtCelular");
        java.lang.String pass = request.getParameter("txtPassword");
        Cl.Burgos.RepararPC.WSDL.TipoLogin tipoLogin = Cl.Burgos.RepararPC.WSDL.TipoLogin.valueOf(request.getParameter("txtTipoLogin")) ;
	// TODO process result here
	boolean result = port.insertarLogin(rut, nombre, apellido, correo, celular, pass, tipoLogin);
...
<html>
    <div class="container" style="margin-top:50px;" >
        <form class="form-horizontal" method="post" action="RegAdmi.jsp">
            <fieldset>
                ...
                <div class="form-group row">
                    <div class="col-md-8 text-center">
                        <button id="crear_user" value="" type="submit" name="submit" class="btn btn-large btn-success"> Registrar</button>
