...
//            this.cmbConsorcio.grabFocus();
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
                try {
                        if(!dAOLogin.sqlUpdate(allClLogin())){
...
//                        Logger.getLogger(FrManteLogin.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            if(!dAOLogin.sqlSearchRut(datosClLogin())){
                if(!dAOLogin.sqlInsert(datosClLogin())){
...
//            Logger.getLogger(FrManteLogin.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
                try {
                        // TODO add your handling code here:
                        if(!dAOLogin.sqlDelete(idClLogin())){
    ...
    private void JTabLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTabLoginMouseClicked
        ...
        if (fila > -1){
            try {
                ...
                this.txtIdLogin.setText(datosCliente[0]);
                ...
                this.txtPass.setText(datosCliente[6]);
                this.jcbTipoCliente.setSelectedItem(TipoLogin.valueOf(datosCliente[7]));
