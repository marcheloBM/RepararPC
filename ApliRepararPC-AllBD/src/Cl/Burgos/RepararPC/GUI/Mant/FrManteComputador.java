...
//        dAOComputador.leerPC(lngDesdeRegistro, (Long.valueOf(this.txtNumReg.getText())),tablaClientes,strBusqueda);
        List<ClComputador> lista=dAOComputador.leerPC(lngDesdeRegistro, (Long.valueOf(this.txtNumReg.getText())),strBusqueda);
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            datos[4]=lista.get(i).getSistemaOpe();
            datos[5]=lista.get(i).getArquitectura();
            datos[6]=lista.get(i).getTipoRepa().toString();
            datos[7]=lista.get(i).getDescripcion();
            datos[8]=Integer.toString(lista.get(i).getValor());
            datos[9]=lista.get(i).getFecha().toString();
            datos[10]=Integer.toString(lista.get(i).getIdCliente());
            datos[11]=Integer.toString(lista.get(i).getIdLogin());
...
//        btnBuscar.setEnabled(true);
    ...
    public ClComputador datosPc() throws Exception{
        ...
        ClComputador pc = new ClComputador(txtMarca.getText(), txtModelo.getText(),
                ...
                jcbTipoRaparacion.getSelectedItem().toString(),
    ...
    private void JTabPC2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTabPC2MouseClicked
        ...
        if (fila > -1){
            try {
                ...
                cargaDatosReparacion(datosCliente[6]);
                ...
                this.txtIdCliente.setText(datosCliente[10]);
                this.txtIdLogin.setText(datosCliente[11]);
