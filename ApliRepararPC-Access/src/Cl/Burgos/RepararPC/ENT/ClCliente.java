...
//    }
    ...
    //Insertar
    public ClCliente(String nombre, String apellido, String correo, String celular, int idLogin) throws Exception {
        setNombre(nombre);
    ...
    //Lista
    public ClCliente(int id,String nombre, String apellido, String correo, String celular, int idLogin) throws Exception {
        setId(id);
        setNombre(nombre);
        setApellido(apellido);
        setCorreo(correo);
    ...
    public ClCliente(String nombre) throws Exception {
        setNombre(nombre);
    }
    
    //Imprimir
    public ClCliente(String nombre, String apellido, String correo, String celular) throws Exception {
        setNombre(nombre);
        setApellido(apellido);
        setCorreo(correo);
        setCelular(celular);
    ...
    public ClCliente(int id,String nombre, String apellido, String correo, String celular) throws Exception {
        setId(id);
        setNombre(nombre);
        setApellido(apellido);
        setCorreo(correo);
    ...
    public String toString() {
        return nombre + ";" + apellido + ";" + correo + ";" + celular;
    }
