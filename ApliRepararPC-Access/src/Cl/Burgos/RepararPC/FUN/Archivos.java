...
import static Cl.Burgos.RepararPC.Conf.Confi.SO;
import static Cl.Burgos.RepararPC.Conf.Confi.userDir;
...
//        File archivo = new File ("E:/informacion.txt");
        ...
        String nombre,apellido,correo,celular,marca,modelo,numserie,SO,arquitectura,fecha;
...
//              
                ClCliente cliente = new ClCliente(nombre, apellido, correo, celular,1);
                
                DAOCliente dAOCliente = new DAOCliente();
                if(!dAOCliente.sqlSearchNombre(cliente)){
                    dAOCliente.sqlInsert(cliente);
                    computador = new ClComputador(marca, modelo, numserie, SO, arquitectura, FormatoFecha.mostrarFechaYMDHMS(fecha));
                }
            }     
        }      
        return computador;
